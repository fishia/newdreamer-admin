...
export const tableFields = [
  ...
  ['厚度', 'thickness', { width: 60, autoHide: true, form: {} }],
  ['成分', 'material', { width: 60, autoHide: true, form: {} }],
  ['克重', 'fabricWeight', { width: 60, autoHide: true, form: {} }],
  ['支数', 'fabricCount', { width: 60, autoHide: true, form: {} }],
  ['弹力', 'elasticity', { width: 60, autoHide: true, form: {} }],
